...
let contains : 'a . 'a -> 'a Prims.list -> Prims.bool = mem
...
let split3 :
  ...
  fun l ->
    fun i ->
      ...
      match uu___ with
      | (a1, rest) ->
          let uu___1 = rest in (match uu___1 with | b::c -> (a1, b, c))
...
type ('a, 'l1, 'l2) strict_suffix_of = Obj.t
type ('uuuuu, 'l1, 'l2) strict_prefix_of = Obj.t
